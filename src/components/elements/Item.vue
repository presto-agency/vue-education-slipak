<template>
  <li v-for="item in list" :key="item.id" class="text-white hover:text-bubble-gum text-center flex items-center flex-col w-1/5 mb-8" v-on:click="gotoCharsertD(id)">
